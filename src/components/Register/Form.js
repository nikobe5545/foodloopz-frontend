...
import {postRegistration} from './registration-actions'
        ...
        <form onSubmit={this.handleSubmit}>
          <div className='form-group p-2'>
            ...
            <input type='text' className='form-control' id='organizationName'
              ...
              placeholder={I18n.t('register.form.name.hint')}
              onInput={this.handleInputOrganizationName}
          ...
          <div className='form-check pt-2 pb-5'>
            <input className='form-check-input' type='checkbox' value='acceptTerms'
              id='termsAndConditions' />
            <label className='form-check-label' htmlFor='termsAndConditions'>
              {I18n.t('register.form.agreement.text')} <a
                href='/terms'>{I18n.t('register.form.agreement.link_text')}</a>
            </label>
          </div>
          <button type='submit'
            className='btn text-white pl-5 pr-5'>{I18n.t('register.form.submit.label')}</button>
        </form>
      </React.Fragment>
    )
  }
